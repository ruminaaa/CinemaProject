...
<head>
    ...
    <title>Sélectionner une Séance</title>
    <style>
        /* Styles globaux */
        body {
...
<body>
    ...
    <div class="container">
        <h1>Sélectionner une Séance pour le Film: ${film.name}</h1>
        ...
        <c:forEach var="salleProg" items="${salleProgs}">
            <div class="seance-form">
                ...
                <form action="reservation" method="POST">
                    ...
                    <!-- Liste déroulante pour les Séances -->
                    <label for="seanceId">Sélectionner une Séance :</label>
                    <select name="seanceId" required>
                        <c:forEach var="seance" items="${salleProg.seances}">
                            <option value="${seance.id_seance}">
                                ${seance.horaire} - Places réservées : ${seance.places}
                            </option>
                        </c:forEach>
                    </select>
        ...
        <a href="reservation?action=showFilms" class="back-link">Retour à la sélection des films</a>
    </div>
